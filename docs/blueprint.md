...
See also: [groups.md](groups.md) for bundling several nodes into one reusable unit, and [vendoring.md](vendoring.md) for pointing `node.source` at a remote module.
