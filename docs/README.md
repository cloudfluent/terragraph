...
- [execution-model.md](execution-model.md): validation, how values are passed, parallelism, concurrent CLI processes, how apply decides what needs applying, the one known limitation
