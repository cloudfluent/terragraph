...
func (e *Engine) Destroy(opts Options) ([]NodeRun, error) {
	...
	defer unlock()
	opts, err = e.prepareOptions(opts, "destroy")
	if err != nil {
		return nil, err
	}
	...
	return e.runLevels(opts, true, func(ctx context.Context, name string, applied map[string]exec.Outputs, out io.Writer) (exec.Outputs, string, error) {
